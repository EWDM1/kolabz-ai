...
const MySettings = () => {
  ...
  return (
    <div className="container max-w-screen-xl mx-auto p-4 py-8 md:p-8">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Button 
                    variant="outline" 
                    className={`flex-col gap-2 h-auto py-4 ${theme === 'light' ? 'border-primary bg-primary/10' : ''}`}
                  ...
                  <Button 
                    variant="outline" 
                    className={`flex-col gap-2 h-auto py-4 ${theme === 'dark' ? 'border-primary bg-primary/10' : ''}`}
                  ...
                  <Button 
                    variant="outline" 
                    className={`flex-col gap-2 h-auto py-4 ${theme === 'system' ? 'border-primary bg-primary/10' : ''}`}
